...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <ThemeSwitch/>
      <h1 className="text-4xl mt-2 text-cyan-300 ">Resource Management System</h1>
      <p className="text-lg mt-4 mx-5 text-justify"> The Resource Management System (RMS) is a web-based platform designed to streamline resource allocation and scheduling within the Arts 
